        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="{{ route('news.show', $banner->news->slug) }}" class="block">
                    <div class="relative flex flex-col gap-1 justify-end p-3 h-72 rounded-xl bg-[url('{{ asset('storage/' . $banner->news->thumbnail) }}')] bg-cover bg-center overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div class="relative col-span-7 lg:row-span-3 border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer">
                <a href="{{ route('news.show', $news[0]->slug) }}">
                    ...
                    <p class="text-slate-400 text-base mt-1">{!! \Str::limit($news[0]->description, 100) !!}</p>
            ...
            <a href="{{ route('news.show', $new->slug) }}" class="relative col-span-5 flex flex-col h-fit md:flex-row gap-3 border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer">
